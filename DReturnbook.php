            ...
            <main class="main-container">
                ...
                <div class="">
                    ...
                    <div id="cardStyle" class="card mx-auto shadow p-5 mb-5 bg-body rounded my-5" style="width: 50%;;">
                        <div class="card-header text-center"><h4 style="color: #008080;">RETURN BOOK</h4></div>
                        <div class="card-body">
                            <div class="card-body">
                                ...
                                <div class="form-group my-2">
                                    <label for="BDueDate">Borrowed Date :</label>
                                    <input type="date" id="BDueDate" class="form-control" disabled=""/>
                                </div>
                                <div class="form-group my-2">
                                    <label for="BDueDate">Current Date :</label>
                                    <input type="date" id="BDueDate" class="form-control" />
                                </div>
                                <button type="submit" class="mt-3 btn btn-secondary btn-lg btn-block form-control">Return</button>
                            </div>
                        </div>
                    </div>
