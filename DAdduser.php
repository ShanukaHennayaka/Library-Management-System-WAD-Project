            ...
            <main class="main-container">
                ...
                <div class="">
                    ...
                    <div id="cardStyle" class="card mx-auto shadow p-3 mb-5 bg-body rounded" style="width: 50%;">
                        <div class="card-header text-center"><h4 style="color: #008080;">ADD NEW USER</h4></div>
                        <div class="card-body">
                            <div class="card-body">
                                ...
                                <div class="form-group my-2">
                                    <label for="SEmail">Student E-mail :</label>
                                ...
                                <div class="form-group my-2">
                                    <label for="snic">Student NIC No :</label>
                                    <input type="number" id="snic" class="form-control" />
                                </div>
                                <div class="form-group my-2">
                                    <label for="spno">Student Phone no :</label>
                                    <input type="number" id="spno" class="form-control" />
                                </div>
                                <button type="button" class="mt-3 btn btn-secondary btn-lg btn-block form-control">ADD USER</button>
                            </div>
                        </div>
                    </div>
